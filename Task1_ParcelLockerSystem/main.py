...
def search_parcel_menu(system: LockerSystem) -> None:
    print("\n--- Search Parcel ---")
    show_navigation_tip()

    while True:
        tracking_id = get_step_input("Tracking ID: ")
        upper_value = tracking_id.upper()
        ...
        print(system.find_parcel(tracking_id))
        return
